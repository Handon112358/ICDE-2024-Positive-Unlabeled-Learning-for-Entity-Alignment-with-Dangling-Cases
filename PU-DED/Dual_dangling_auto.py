...
# fig_save='data/GA-XX/GA-FR/0.25_en/'
# fig_save='data/GA-XX/GA-JA/0.25_en/'
# fig_save='data/GA-XX/GA-ZH/0.25_en/'
# fig_save='data/GA-XX/GA-EN/0.25_en/'
...
#                     '''enhancement'''
                ...
                def draw_pi(Pi_p, Pi_p_u):
                    ...
                    plt.show()
                    np.savetxt(fig_save+'Pi_p.txt', Pi_p, fmt='%f', delimiter=',')
                    np.savetxt(fig_save+'Pi_p.txt', Pi_p_u, fmt='%f', delimiter=',')
                ...
                def draw_loss(loss):
                    ...
                    np.savetxt(fig_save+'loss.txt', loss, fmt='%f', delimiter=',')
