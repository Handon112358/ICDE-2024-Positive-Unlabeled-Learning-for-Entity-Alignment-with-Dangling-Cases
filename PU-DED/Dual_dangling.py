...
# fig_save="data/en_fr_15k_V1/"

train_pair,dev_pair,adj_matrix,r_index,r_val,adj_features,rel_features,target_dis_tag,new_indexes,y_true,max_val1,max_val2 = load_data(fig_save,train_ratio=0.30)
    ...
    for j in range(1):
        for k in range(1):
            for l in range(1):
                ...
                re_weight = []
                epoch = 20
                for turn in range(13):#6 for GA16k
